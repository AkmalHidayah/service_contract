                            ...
                            <div class="bg-gray-50 shadow-md rounded-lg p-4 border border-gray-200 hover:shadow-lg transition duration-200">
                                ...
                                <div class="mt-2 text-xs">
                                    ...
                                    @if($notification->isAbnormalAvailable)
                                        <a href="{{ route('abnormal.view', ['notificationNumber' => $notification->notification_number]) }}" class="text-red-500 font-semibold" target="_blank">Abnormalitas</a>
                                    @else
                                ...
                                <div class="mt-2 text-xs flex items-center space-x-2">
                                    ...
                                    @else
                                        <span class="text-gray-500">Dokumen SPK: Tidak Tersedia</span>
                                    @endif
                                </div>


                                <!-- Form untuk Update Progress -->
                                <form method="POST" action="{{ route('jobwaiting.updateProgress', $notification->notification_number) }}">
                                    @csrf
                                    <div class="mt-3">
