                    ...
                    <div class="grid grid-cols-4 gap-0">
                        <div class="col-span-3 text-left border-r border-black p-2 pb-0">
                            <div class="grid grid-cols-3 gap-0">
                                <div class="col-span-1 text-sm font-medium mb-0">NOTIFIKASI</div>
            ...
            <tbody>
                ...
                @foreach($uraian_pekerjaan as $index => $uraian)
                    <tr>
                        ...
                        <td class="border border-gray-400 px-2 py-1 text-center">{{ $harga_material[$index] ?? '-' }}</td>
                        <td class="border border-gray-400 px-2 py-1 text-center">{{ $harga_consumable[$index] ?? '-' }}</td>
                        <td class="border border-gray-400 px-2 py-1 text-center">{{ $harga_upah[$index] ?? '-' }}</td>
                        <td class="border border-gray-400 px-2 py-1 text-center">{{ $jumlah_harga_material[$index] ?? '-' }}</td>
                        <td class="border border-gray-400 px-2 py-1 text-center">{{ $jumlah_harga_consumable[$index] ?? '-' }}</td>
                        <td class="border border-gray-400 px-2 py-1 text-center">{{ $jumlah_harga_upah[$index] ?? '-' }}</td>
                        <td class="border border-gray-400 px-2 py-1 text-center">{{ $harga_total[$index] ?? '-' }}</td>
                ...
                <tr>
                    ...
                    <td colspan="1" class="border border-gray-400 px-2 py-1 text-center bg-gray-200"><strong>{{ number_format($hpp->total_amount, 2) }}</strong></td>
                ...
                <td class="border border-black px-2 py-2 text-left" style="vertical-align: top; width: 20%;">
                    ...
                    <td class="px-2 py-2" style="width: 30%; border: 1px solid black;">
                        <table class="min-w-full border-collapse text-xs" style="border: 1px solid black;">
                            ...
                            <tr>
                                <td class="px-2 py-4 text-center" style="width: 33%; border-right: 1px solid black;"><strong>Director of Operation</strong></td>
                                <td class="px-2 py-4 text-center" style="width: 34%; border-right: 1px solid black;"><strong>GM of Project Management & Maint. Support</strong></td>
                                <td class="px-2 py-4 text-center" style="width: 33%;"><strong>SM Of Workshop</strong></td>
                            </tr>
                            <tr>
                            <!-- Tampilkan tanda tangan Director of Operation -->
                            <td class="px-2 py-4 text-center" style="width: 33%; border-right: 1px solid black;">
                                @if($hpp->director_signature)
                                    <img src="{{ $hpp->director_signature }}" alt="Director Signature" style="width: 150px; height: auto;">
                                @else
                                    <strong>TTD</strong>
                                @endif
                            </td>

                            <!-- Tampilkan tanda tangan GM of Project Management & Maint. Support -->
                            <td class="px-2 py-4 text-center" style="width: 34%; border-right: 1px solid black;">
                                @if($hpp->general_manager_signature)
                                    <img src="{{ $hpp->general_manager_signature }}" alt="GM Signature" style="width: 150px; height: auto;">
                                @else
                                    <strong>TTD</strong>
                                @endif
                            </td>

                            <!-- Tampilkan tanda tangan SM of Workshop -->
                            <td class="px-2 py-4 text-center" style="width: 33%;">
                                @if($hpp->senior_manager_signature)
                                    <img src="{{ $hpp->senior_manager_signature }}" alt="Senior Manager Signature" style="width: 150px; height: auto;">
                                @else
                                    <strong>TTD</strong>
                                @endif
                            </td>
                            ...
                            <tr>
                                <td class="px-2 py-4 text-center" style="width: 33%; border-right: 1px solid black; border-bottom: 1px solid black;">Mochamad Alfin Zaini</td>
                                <td class="px-2 py-4 text-center" style="width: 34%; border-right: 1px solid black; border-bottom: 1px solid black;">Bakri Syafar, S. T</td>
                                <td class="px-2 py-4 text-center" style="width: 33%; border-bottom: 1px solid black;">Asrizal</td>
                            </tr>
                            <tr> 
