                    ...
                    <div class="grid grid-cols-4 gap-0">
                        ...
                        <div class="text-left p-2">
                            <table class="w-full text-xs border border-black">
                                ...
                                <tr>
                                    <td class="px-2 py-4 text-center" style="width: 50%; border-right: 1px solid black;"><strong>SM Of  @if(!is_null($hpp->seniorManagerUser))
                                                    {{ $hpp->seniorManagerUser->unit_work }}
                                                @else
                                                    <span>Unit Kerja Tidak Tersedia</span>
                                                @endif</strong></td>
                                    <td class="px-2 py-4 text-center" style="width: 50%; border-right: 1px solid black;"><strong>Section Of Workshop</strong></td>
                                </tr>
                                <tr>
                                ...
                                @else
                                    <strong>TTD</strong>
                                @endif
                                    <td class="px-2 py-4 text-center" style="width: 50%; border-right: 1px solid black;"> {{ $hpp->managerSignatureUser ? $hpp->managerSignatureUser->name : 'N/A' }}
                                ...
                                <tr>
                                    <td class="w-1/2 border-r border-b border-black py-2 text-center">{{ $hpp->seniorManagerSignatureUser ? $hpp->seniorManagerSignatureUser->name : 'N/A' }}</td>
                                    <td class="w-1/2 border-b border-black py-2 text-center">{{ $hpp->managerSignatureUser ? $hpp->managerSignatureUser->name : 'N/A' }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <table class="min-w-full border border-black text-xs">
                    ...
                    <td class="px-2 py-2" style="width: 30%; border: 1px solid black;">
                        <table class="min-w-full border-collapse text-xs" style="border: 1px solid black;">
                            ...
                            <tr>
                                <td class="px-2 py-4 text-center" style="width: 34%; border-right: 1px solid black;"><strong>GM of @if(!is_null($hpp->generalManagerUser))
                                                    {{ $hpp->generalManagerUser->departemen }}
                                                @else
                                                    <span>Departemen Kerja Tidak Tersedia</span>
                                                @endif</strong></td></strong></td>
                            </tr>
                            <tr>
                                <td class="px-2 py-4 text-center" style="width: 34%; border-right: 1px solid black;">@if($hpp->general_manager_signature)
