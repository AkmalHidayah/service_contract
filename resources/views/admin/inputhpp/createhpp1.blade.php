    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <h2 class="font-semibold text-3xl text-gray-800 leading-tight">Form Input HPP di Atas 250 Juta</h2>
                                        ...
                                        <div class="sub-uraian-container mt-6">
                                            <div class="mt-4">
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-5 gap-2 mt-1">
                                                    ...
                                                    <input type="text" placeholder="Qty" name="qty[]" class="col-span-1 block w-full border border-gray-300 rounded-md shadow-sm py-1 px-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
