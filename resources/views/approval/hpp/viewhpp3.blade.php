                    ...
                    <div class="grid grid-cols-4 gap-0">
                        ...
                        <div class="text-left p-2">
                            <table class="w-full text-xs border border-black">
                                ...
                                <tr>
                                    <td class="px-2 py-4 text-center" style="width: 50%; border-right: 1px solid black;"><strong>SM OF WORKSHOP</strong></td>
                                    <td class="px-2 py-4 text-center" style="width: 50%; border-right: 1px solid black;"><strong>Section Of Workshop</strong></td>
                                </tr>
                                <tr>
                                    <td class="px-2 py-4 text-center" style="width: 50%; border-right: 1px solid black;"><strong>TTD</strong></td>
                                    <td class="px-2 py-4 text-center" style="width: 50%; border-right: 1px solid black;"><strong>TTD</strong></td>
                                </tr>
                                <tr>
                                    <td class="w-1/2 border-r border-b border-black py-2 text-center">Asriza, S.T</td>
                                    <td class="w-1/2 border-b border-black py-2 text-center">Herwanto S</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <table class="min-w-full border border-black text-xs">
                    ...
                    <td class="px-2 py-2" style="width: 30%; border: 1px solid black;">
                        <table class="min-w-full border-collapse text-xs" style="border: 1px solid black;">
                            ...
                            <tr>
                                <td class="px-2 py-4 text-center" style="width: 34%; border-right: 1px solid black;"><strong>TTD</strong></td>
                            </tr>
                            <tr>
