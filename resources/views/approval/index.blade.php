                            ...
                            @foreach ($abnormals as $abnormal)
                                <tr>
                                    ...
                                    <td class="px-4 py-4 border-b border-gray-300 text-sm whitespace-nowrap">
                                        <a href="{{ route('abnormal.view', ['notificationNumber' => $abnormal->notification_number]) }}" class="bg-red-600 text-white px-2 py-1 rounded hover:bg-red-700 text-xs flex items-center gap-1 transition-all duration-200 ease-in-out" target="_blank">
                                            Abnormalitas
