...
<nav style="background: linear-gradient(90deg, #ffffff, #f5f5f5);" class="shadow-md fixed top-0 left-0 w-full z-50">
    <div class="px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="text-gray-900 hidden sm:block">
                <span class="font-bold text-base sm:text-lg block tracking-wider">WORKSHOP</span>
                <span class="text-xs sm:text-sm">Dept. Of Project Management & Main Support</span>
            </div>
        </div>
        ...
        <div class="hidden sm:flex space-x-4">
            <a href="{{ asset('downloads/cara_kerja.pdf') }}" download class="text-sm text-green-500 hover:underline transition">
                Download Cara Kerja
            </a>
            <a href="{{ asset('downloads/flowchart_aplikasi.xlsx') }}" download class="text-sm text-blue-500 hover:underline transition">
                Download Flowchart
            </a>
            <a href="https://www.appsheet.com/start/5d8aa0c0-02e4-40da-864d-eacdb78cfd92?platform=desktop#vss=H4sIAAAAAAAAA52OvQ7CMBCD38VzniArYkCoLCAWwhCaqxTRJlWTAFWUd-fCj1iB8Xz-bGdcLF23UbdnyEP-XGuaIZEVdvNIClJh4V2cfK8gFDZ6eIoNuaRQUI7izUYKkPl7VP7fKmANuWg7S1PNqRTzL4bflWCh-lEEhhT1qafHSPaXwlrn2xTI7HnCj9Vh5Za3UTvTeMNxne4DlTudAZXRUQEAAA==&view=Menu&appName=E-REPORT-919375348" 
                class="bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 transition">
                E-Report
            </a>
            <a href="/login" class="bg-gray-800 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition">
    ...
    <!-- Mobile Menu -->
    <div x-show="isOpen" class="sm:hidden bg-white shadow-lg px-4 py-2 space-y-2">
        <a href="https://www.appsheet.com/start/5d8aa0c0-02e4-40da-864d-eacdb78cfd92?platform=desktop#vss=H4sIAAAAAAAAA52OvQ7CMBCD38VzniArYkCoLCAWwhCaqxTRJlWTAFWUd-fCj1iB8Xz-bGdcLF23UbdnyEP-XGuaIZEVdvNIClJh4V2cfK8gFDZ6eIoNuaRQUI7izUYKkPl7VP7fKmANuWg7S1PNqRTzL4bflWCh-lEEhhT1qafHSPaXwlrn2xTI7HnCj9Vh5Za3UTvTeMNxne4DlTudAZXRUQEAAA==&view=Menu&appName=E-REPORT-919375348" 
           class="block text-orange-500 hover:underline py-2 text-sm">
            E-Report
        </a>
        <a href="{{ asset('downloads/cara_kerja.pdf') }}" download class="block text-green-500 hover:underline py-2 text-sm">
            Download Cara Kerja
        </a>
        <a href="{{ asset('downloads/flowchart_aplikasi.pdf') }}" download class="block text-blue-500 hover:underline py-2 text-sm">
            Download Flowchart
        </a>
        <a href="/login" class="block text-gray-800 hover:underline py-2 text-sm">
            Login
        </a>
    </div>
</nav>
